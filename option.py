...
parser.add_argument('--nThread', type=int, default=0, help='number of threads for data loading')
parser.add_argument('--cpu', action='store_true', help='use cpu only')
parser.add_argument('--nGPU', type=int, default=2, help='number of GPUs')

parser.add_argument("--datadir", type=str, default=r'/hhd12306/nihao/pre_selection', help='dataset directory')
parser.add_argument('--data_train', type=str, default='contest', help='train dataset name')
parser.add_argument('--data_test', type=str, default='contest', help='test dataset name')
...
parser.add_argument('--test_every', type=int, default=40, help='do test per every N epochs')
...
parser.add_argument('--num_classes', type=int, default=2772, help='')
...
parser.add_argument('--lr_decay', type=int, default=80, help='learning rate decay per N epochs')
