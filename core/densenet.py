...
def densenet121(num_classes, pretrained=True, **kwargs):
    model = DenseNet(
...
def densenet161(num_classes, pretrained=True, **kwargs):
    model = DenseNet(
        num_classes=num_classes,
        growth_rate=48,
...
def densenet169(num_classes, pretrained=True, **kwargs):
    model = DenseNet(
        num_classes=num_classes,
        growth_rate=32,
...
def densenet201(num_classes, pretrained=True, **kwargs):
    model = DenseNet(
        num_classes=num_classes,
        growth_rate=32,
