...
class checkpoint():
    def __init__(self, args):
        ...
        if args.load == '':
            ...
            self.dir = './out/' + args.save
        else:
            self.dir = './out/' + args.load
            if not os.path.exists(self.dir):
                args.load = ''
            else:
                self.log = torch.load(self.dir + '/map_log_39.pt')
    ...
    def save(self, trainer, epoch, is_best=False):
        ...
        torch.save(self.log, os.path.join(self.dir, 'map_log_{}.pt'.format(str(epoch))))
        torch.save(
            trainer.optimizer.state_dict(),
            os.path.join(self.dir, 'optimizer_{}.pt'.format(str(epoch)))
        )
