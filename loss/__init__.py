...
from loss.CrossEntropyLabelSmooth import CrossEntropyLabelSmooth
from loss.AngularSoftmaxWithLoss import AngularSoftmaxWithLoss

from data import Data

class Loss(nn.modules.loss._Loss):
    def __init__(self, args, ckpt, weights):
    ...
    def plot_loss(self, apath, epoch):
        ...
        for i, l in enumerate(self.loss):
            ...
            plt.close(fig)
            print("图片输出完毕:",'{}/loss_{}.jpg'.format(apath, l['type']))
